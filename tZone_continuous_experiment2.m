function code = tZone_continuous_experiment2
...
vr.experimentV2 = true;
vr.experimentV3 = false;
...
if vr.experimentV2
    disp('VERSION 2!');
    vr.prevRewardSide = 'left'; % keep track of where the last reward was given (arbitrarily start with left)
    vr.doorSide = 'left'; % want the mouse to go to the right to start
    vr.hasMovingDoor = true;
end
